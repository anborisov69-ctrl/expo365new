...
export const NEWS_ITEMS: NewsItem[] = [
  ...
  // ══════════════════════════════════════════════════════════════════════════════
  // ООО "ТЕСТ" — экспонент-демо EXPO 365 HoReCa
  // exhibitorSlug: 'ooo-test' → синхронизируется с витриной через EcosystemProvider
  // ══════════════════════════════════════════════════════════════════════════════

  // ── ООО "ТЕСТ": Новинка — Barista Pro X3 ─────────────────────────────────────
  {
    id:            'ooo-test-news-001',
    exhibitorId:   'exp-ooo-test',
    exhibitorName: 'ООО «ТЕСТ»',
    exhibitorLogo: null,
    exhibitorSlug: 'ooo-test',
    title:
      'Barista Pro X3 — профессиональная эспрессо-машина нового поколения',
    description:
      'ООО «ТЕСТ» представляет эксклюзивную собственную разработку: 2-групповая машина с двойным бойлером и PID ±0.1°C.',
    content: [
      'ООО «ТЕСТ» официально выводит на рынок Barista Pro X3 — профессиональную эспрессо-машину класса Heavy Duty.',
      '',
      'Технические характеристики:',
      '• Двойной бойлер: паровой 1.8 л + заварочный 0.6 л — PID ±0.1°C',
      '• 2 независимые группы E61 58 мм — одновременный налив',
      '• Давление: 9 бар рабочее, регулируемое от 6 до 12 бар',
      '• Мощность: 3 500 Вт (220В, 16А)',
      '• Производительность: до 200 порций эспрессо в сутки',
      '• Подключение: WiFi-модуль + приложение iOS/Android',
      '',
      'Цвета: нержавеющая сталь, матовый чёрный, RAL по запросу.',
      '',
      'Специальное предложение для байеров по ссылке приглашения:',
      '• Цена по ссылке /inv/ooo-test: ₽ 108 000 (базовый прайс: ₽ 128 000)',
      '• Бесплатная установка + обучение персонала (2 ч)',
      '• Гарантия 24 мес. против стандартных 12 мес.',
    ].join('\n'),
    industryTag:  'coffee',
    promoType:    'new',
    timerLabel:   'Ещё 7 дн',
  ...
  // ── ООО "ТЕСТ": Спецпредложение — HoReCa Blend №7 ────────────────────────────
  {
    id:            'ooo-test-news-002',
    exhibitorId:   'exp-ooo-test',
    exhibitorName: 'ООО «ТЕСТ»',
    exhibitorLogo: null,
    exhibitorSlug: 'ooo-test',
    title:
      'HoReCa Blend №7 — партнёрская цена ₽ 1 650/кг для клиентов по ссылке приглашения',
    description:
      'Купаж 70% арабика / 30% робуста. Устойчивый крем до 75°C. Спецпредложение для новых B2B-партнёров.',
    content: [
      'ООО «ТЕСТ» объявляет партнёрское предложение на флагманский купаж HoReCa Blend №7.',
      '',
      'Характеристики:',
      '• Состав: 70% арабика (Бразилия, Колумбия) + 30% робуста (Вьетнам)',
      '• Обжарка: средняя (Medium Roast), дата обжарки — не более 14 дней',
      '• Крем: устойчив при температуре молока до 75°C',
      '• Упаковка: вакуумная, клапан дегазации, 1 кг / 5 кг под заказ',
      '• Рекомендованная дозировка: 18-20 г на двойной эспрессо',
      '',
      'Условия партнёрской поставки:',
      '• Минимальный заказ: 5 кг',
      '• Базовая цена: ₽ 1 950/кг',
      '• Цена для партнёров по ссылке /ref/ooo-test: ₽ 1 650/кг',
      '• Доставка за счёт ООО «ТЕСТ» при заказе от 20 кг',
    ].join('\n'),
    industryTag:  'coffee',
    promoType:    'special',
    timerLabel:   'Ещё 14 дн',
  ...
  // ── ООО "ТЕСТ": Новинка — Тренинг "Латте-арт Мастер" ─────────────────────────
  {
    id:            'ooo-test-news-003',
    exhibitorId:   'exp-ooo-test',
    exhibitorName: 'ООО «ТЕСТ»',
    exhibitorLogo: null,
    exhibitorSlug: 'ooo-test',
    title:
      'Новый тренинг "Латте-арт Мастер" — сертификат EXPO 365',
    description:
      'Запустили 8-часовой практический интенсив для барист. Группы до 8 чел. Партнёрская цена: ₽ 9 000.',
    industryTag:  'coffee',
    promoType:    'new',
    timerLabel:   'Ещё 21 дн',
    date:         '2026-05-06',
  },
];
